...
public class SecurityConfiguration {
	...
	SecurityWebFilterChain springSecurityFilterChain(ServerHttpSecurity http) {
		...
		.pathMatchers("/actuator/**", "/**", "/send-email", "/send-email-attachment",
						"/send-emails-via-csv","/send-email-template","/send-otp-email","/save-customer",
						"/new-subscriber", "/subscribe","/unsubscribe","/upload-aws","/set-run",
						"/otp-email","/share-via-email","/set-run-update")
